        ...
        >
            ...
            >
                ...
                <aside
                    ...
                    ref={panelRef}
                    className="staggered-menu-panel absolute top-0 right-0 h-full bg-(--surface-color) flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-md pointer-events-auto"
                        ...
                        >
                            {items && items.length ? (
                                ...
                                <li className="sm-panel-itemWrap relative overflow-hidden leading-none" aria-hidden="true">
                                    <span className="sm-panel-item relative text-(--primary-text-color) font-semibold text-[2.5rem] cursor-pointer leading-none tracking-[-1px] uppercase transition-[background,color] duration-150 ease-linear inline-block no-underline pr-[0.8em]">
                                        <span className="sm-panel-itemLabel inline-block origin-[50%_100%] will-change-transform">
                                            No items
                                        </span>
                                    </span>
